      ...
      <div style={{display: 'flex',  justifyContent:'center'}}>
        <form onSubmit={this.handleSubmit}>
          <label>
            ...
            <div style={{textAlign: 'center'}}>
              <select value={this.state.from} onChange={this.handleChangeTo} className="InputFromTo">
              ...
              <select value={this.state.to} onChange={this.handleChangeFrom} className="InputFromTo">
